-- Final Database Schema Fix for PocketSpend
...
-- Recreate all foreign key constraints with proper types
...
INSERT IGNORE INTO users (username, password) VALUES ('testuser', 'password123'); 